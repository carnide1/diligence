...
3. Vercel Cron (`vercel.json` runs daily at 16:00 UTC — roughly late morning US) will call `/api/cron/nudge`. When `CRON_SECRET` is set, Vercel sends `Authorization: Bearer <CRON_SECRET>`.
